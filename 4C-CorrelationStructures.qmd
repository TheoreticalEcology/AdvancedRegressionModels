...
If we would have still seen a signal, we should have fit an autoregressive model. Here it's not neccessary, but just to show you the syntax - first nlme:
