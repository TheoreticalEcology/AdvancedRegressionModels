...
| **paired t.test**                |                                       |                               |
+----------------------------------+---------------------------------------+-------------------------------+
| y depends on continuous x        | `cor.test(x, y)`                      | `lm(y~x)`                     |
|                                  |                                       |                               |
| **Pearson correlation**          |                                       |                               |
+----------------------------------+---------------------------------------+-------------------------------+
| y depends on continuous x        | `cor.test(x, y, method = "spearman")` | `lm(rank(y)~rank(x))`         |
|                                  |                                       |                               |
| **Spearman correlation**         |                                       |                               |
+----------------------------------+---------------------------------------+-------------------------------+
| y differs within a group         | `aov(y~group)`                        | `lm(y~group)`                 |
|                                  |                                       |                               |
| **One-way ANOVA**                |                                       |                               |
+----------------------------------+---------------------------------------+-------------------------------+
