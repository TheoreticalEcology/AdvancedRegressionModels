...
We have correlations between variables and an interaction, so should run a type II or III Anova, for III you should center predictors. For convenience, I will run a type II:
