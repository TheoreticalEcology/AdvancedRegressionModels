...
The functional forms of our confounders are not perfect. Since we are not really interested in them, we can use a GAM to flexibly account for them:
...
Let's take another look at the functional forms of our confounders:
